...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_cmi_statements_id"), "cmi_statements", ["id"], unique=False
    )
    op.create_table(
        "users",
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["course_id"],
            ["cmi_courses.id"],
            name=op.f("fk_cmi5_course_users_course_id_cmi_courses"),
        ),
        sa.ForeignKeyConstraint(
            ["statement_id"],
            ["cmi_statements.id"],
            name=op.f("fk_cmi5_course_users_statement_id_cmi_statements"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_cmi5_course_users_user_id_users")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_cmi5_course_users")),
    )
    op.create_index(
        op.f("ix_cmi5_course_users_id"), "cmi5_course_users", ["id"], unique=False
    )
